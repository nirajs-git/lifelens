...
async function updatePatient(req, res) {
  try {
    ...
    existingPatient.meanCorpuscularHemoglobinConcentration =
      meanCorpuscularHemoglobinConcentration;
...
async function uploadPatients(req, res) {
    try {
      const { patientRecords } = req.body; // Access patientRecords from req.body
      console.log(patientRecords); // Ensure you're receiving the data correctly
      ...
      for (const record of patientRecords) {
        ...
        // Create a patient object and push it to the array
        patients.push({
          fname,
          lname,
          age,
      ...
      // Insert all patient records into the database
